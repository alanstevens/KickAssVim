...
def install_sensible_task
  dir = File.expand_path "#{File.expand_path("../", __FILE__)}/config"
  FileUtils.mkdir_p(dir) unless File.exists?(dir)
  sh "curl -Sso #{dir}/sensible.vim https://raw.github.com/tpope/vim-sensible/master/plugin/sensible.vim"
end
...
install_plugin_task "itspriddle/vim-jquery"
install_plugin_task "groenewege/vim-less"
install_plugin_task "tpope/vim-markdown"
install_plugin_task "juvenn/mustache.vim"
...
install_plugin_task "slim-template/vim-slim" # slim syntax highlighting for vim
...
install_plugin_task "Chiel92/vim-autoformat" # Provides easy code formatting in Vim by integrating existing code formatters.
# install_plugin_task "vim-scripts/bufexplorer.zip"
install_plugin_task "jeetsukumaran/vim-buffergator" # list, select and switch between buffers.
install_plugin_task "duff/vim-bufonly" # quickly close all other buffers
install_plugin_task "tpope/vim-bundler" # Lightweight support for Ruby's Bundler
...
install_plugin_task "Raimondi/delimitMate" # provides insert mode auto-completion for quotes, parens, brackets, etc.
install_plugin_task "Lokaltog/vim-easymotion" # Vim motions on speed!
install_plugin_task "tpope/vim-endwise"
install_plugin_task "tpope/vim-fugitive"
# install_plugin_task "vim-scripts/greplace.vim"
install_plugin_task "sjl/gundo.vim" # provides an undo graph window
...
install_plugin_task "jistr/vim-nerdtree-tabs" # NERDTree and tabs together in Vim, painlessly
...
install_plugin_task "tpope/vim-rbenv"
...
install_plugin_task "majutsushi/tagbar" # displays a list of ctags in a sidebar
...
install_plugin_task "tpope/vim-unimpaired" # pairs of handy bracket mappings
...
install_plugin_task "vim-scripts/YankRing.vim" # provides a yank buffer history
