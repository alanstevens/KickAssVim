...
function! RotateColorTheme(reverse)
  let colorlist = ["ir_black","mac_classic","solarized","github","pyte","liquidcarbon","rootwater","twilight","darkspectrum","zmrok","jellybeans","moria","getafe","wombat","freya","camo","desert","desert256","jammy"]
  if a:reverse
    let g:themeindex -= 1
  else
    let g:themeindex += 1
